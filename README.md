...
_Install YASB using Chocolatey_
...
| [Monitor Profile](<https://github.com/amnweb/yasb/wiki/(Widget)-Monitor-Profile>)                   | Saves and switches between monitor layout profiles (positions, resolution, refresh rate).                     |
