...
from PyQt6.QtCore import Qt, QRect, QEvent, QPropertyAnimation, QEasingCurve, pyqtSignal
from core.bar_helper import BarContextMenu, OsThemeManager, FullscreenManager, AutoHideManager
...
class Bar(QWidget):
    ...
    def showEvent(self, event):
        ...
        if self._fullscreen_manager and not hasattr(self, "_fullscreen_monitoring_started"):
            self._fullscreen_manager.start_monitoring(500)
