...
class PowerPlanWidget(BaseWidget):
    ...
    def _show_menu(self):
        ...
        for plan in self._plans:
            ...
            btn.clicked.connect(lambda checked, guid=plan['guid'], name=plan['name']: 
    ...
    def _guids_equal(self, guid1, guid2):
        ...
        try:
            return (ctypes.string_at(ctypes.byref(guid1), ctypes.sizeof(GUID)) ==
    ...
    def get_power_plans(self):
        ...
        while True:
            ...
            res = PowerEnumerate(
                None, None, None, 16, index,
                guid_buf, ctypes.byref(size)
            )
            if res != 0:
                break
