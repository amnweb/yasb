...
class ClipboardPopup(PopupWidget):
    ...
    def _render_items(self, items):
        ...
        # Let CSS handle padding/margin - don't set hardcoded margins
        ...
        if not items:
            ...
            for item in items:
                ...
                # Use horizontal layout for all items (text and image)
                ...
                if item["type"] == "text":
                    ...
                    if self._menu_config.tooltip_enabled:
                        ...
                        set_tooltip(content_area, wrapped_text, delay=self._menu_config.tooltip_delay, position="top")
                else:
                    ...
                    if self._menu_config.show_image_thumbnail:
                        ...
                        btn.setText("")
                        # Make button size fixed to icon size
                ...
                # Add image info stacked vertically to the right of the image
                if item["type"] == "image" and self._menu_config.show_image_list_info:
                    ...
                    info_container.setSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Fixed)
                ...
                # Use minimum height for delete button to match content area
                del_btn.setMinimumHeight(content_area.sizeHint().height())
