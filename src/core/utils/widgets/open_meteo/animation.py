...
from core.utils.widgets.open_meteo.utils import create_path_from_points, find_point_and_percent

if TYPE_CHECKING:
    from core.utils.widgets.open_meteo.widgets import HourlyData
