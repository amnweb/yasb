...
class TrafficDataManager:
    ...
    _interface_data: dict[str, dict] = {}  # {interface: {total_bytes_sent, total_bytes_recv, today_sent, today_recv, etc}}
    ...
    def initialize_interface(cls, interface: str):
        ...
        if interface in cls._interface_data and cls._interface_data[interface].get('_loaded', False):
            return cls._interface_data[interface]['session_start_sent'], cls._interface_data[interface]['session_start_recv']
    ...
    def calculate_network_data(
        ...
        try:
            ...
            return {
                ...
                'session_downloaded': cls._apply_alignment(session_downloaded, max_label_length, max_label_length_align),
                'session_duration': session_duration,
                'alltime_uploaded': cls._apply_alignment(alltime_uploaded, max_label_length, max_label_length_align),
                'alltime_downloaded': cls._apply_alignment(alltime_downloaded, max_label_length, max_label_length_align),
    ...
    def initialize_today_tracking(cls, interface: str):
        ...
        try:
            ...
            if cls._interface_data[interface]['session_start_sent'] is None or cls._interface_data[interface]['session_start_recv'] is None:
            ...
            if cls._interface_data[interface]['today_date'] != today:
                ...
                cls._interface_data[interface]['today_start_sent'] = current_io.bytes_sent - cls._interface_data[interface]['today_sent']
                cls._interface_data[interface]['today_start_recv'] = current_io.bytes_recv - cls._interface_data[interface]['today_recv']
    ...
    def update_today_and_total_tracking(cls, interface: str, current_io):
        ...
        try:
            ...
            if (cls._interface_data[interface]['today_start_sent'] is not None and 
                cls._interface_data[interface]['today_start_recv'] is not None):
                
                # Handle counter resets
                if current_io.bytes_sent >= cls._interface_data[interface]['today_start_sent']:
                    cls._interface_data[interface]['today_sent'] = current_io.bytes_sent - cls._interface_data[interface]['today_start_sent']
                if current_io.bytes_recv >= cls._interface_data[interface]['today_start_recv']:
                    cls._interface_data[interface]['today_recv'] = current_io.bytes_recv - cls._interface_data[interface]['today_start_recv']
